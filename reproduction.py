...
# Setup the trainer
checkpoint_callback = ModelCheckpoint(dirpath='models/my_model/', save_top_k=1, monitor='val_loss')
lr_monitor = LearningRateMonitor(logging_interval='step')
trainer = Trainer(max_epochs=80000, accelerator='gpu', devices=1, logger=TensorBoardLogger('tblogs/'), callbacks=[checkpoint_callback, lr_monitor])
