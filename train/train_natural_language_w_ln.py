...
# Setup the trainer
write_path = Path(f'models/natural_language_abs_pos_{t}')
write_path.mkdir()
...
trainer = Trainer(max_epochs=4000, accelerator='gpu', devices=1, logger=TensorBoardLogger('tblogs/'), callbacks=[checkpoint_callback, lr_monitor])
