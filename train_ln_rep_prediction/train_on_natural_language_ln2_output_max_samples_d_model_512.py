...
if IS_FIRST:
    ...
    torch.save(train_embeddings, f'/home/nlp/matan_avitan/ln_rep_prediction/train_embeddings_D_MODEL_{D_MODEL}.pt')
    torch.save(test_embeddings,  f'/home/nlp/matan_avitan/ln_rep_prediction/test_embeddings_D_MODEL_{D_MODEL}.pt')
else:
    train_embeddings = torch.load(f'/home/nlp/matan_avitan/ln_rep_prediction/train_embeddings_D_MODEL_{D_MODEL}.pt')
    test_embeddings  = torch.load(f'/home/nlp/matan_avitan/ln_rep_prediction/test_embeddings_D_MODEL_{D_MODEL}.pt')
...
train_loader = DataLoader(TensorDataset(train_embeddings, train_labels),
                          batch_size=BATCH_SIZE, shuffle=True,  pin_memory=True, num_workers=64)
test_loader  = DataLoader(TensorDataset(test_embeddings,  test_labels),
                          batch_size=BATCH_SIZE, shuffle=False, pin_memory=True, num_workers=64)
