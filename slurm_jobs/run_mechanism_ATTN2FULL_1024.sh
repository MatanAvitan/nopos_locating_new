#!/bin/bash
#SBATCH --job-name=A2F-1024
#SBATCH --output=logs/slurm_mechanism_ATTN2FULL_1024_%j.out
#SBATCH --error=logs/slurm_mechanism_ATTN2FULL_1024_%j.err
...
python train_2layer_mechanism.py \
    ...
    --wandb \
    --no_compile \
    --out_dir out-mechanism-ATTN2FULL-1024
