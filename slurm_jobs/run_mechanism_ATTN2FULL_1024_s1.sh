#!/bin/bash
#SBATCH --job-name=A2F-1024-s1
#SBATCH --output=logs/slurm_mechanism_ATTN2FULL_1024_s1_%j.out
#SBATCH --error=logs/slurm_mechanism_ATTN2FULL_1024_s1_%j.err
...
python train_2layer_mechanism.py \
    ...
    --wandb \
    --no_compile \
    --seed 1 --out_dir out-mechanism-ATTN2FULL-1024-s1
