# Training config for 12-layer NoPE transformer with LayerNorm on OpenWebText
# Deeper model to study how positional encoding propagates through layers
#
# Key features:
...
#
# Run with:
#   CUDA_VISIBLE_DEVICES=0 python train_nope.py config/train_nope_owt_ln_12layer.py

# I/O
out_dir = "out-nope-owt-ln-12layer"
...
wandb_run_name = "nope-owt-ln-12layer"
